...
@php 
		...
		$review= App\Models\ClientReview::all();
					...
					<div class="col-xl-3 col-sm-6 m-t35">
						<div class="card card-coin">
							<div class="card-body text-center">
								...
								<h2 class="text-black mb-2 font-w600">{{count($user)}}</h2>
								<p class="mb-0 fs-14">
									...
									<span class="text-success mr-1">User</span>
								</p>	
							</div>
						</div>
					</div>
					<div class="col-xl-3 col-sm-6 m-t35">
						<div class="card card-coin">
							<div class="card-body text-center">
								...
								<h2 class="text-black mb-2 font-w600">{{count($review)}}</h2>
								<p class="mb-0 fs-13">
									<svg width="29" height="22" viewBox="0 0 29 22" fill="none" xmlns="http://www.w3.org/2000/svg">
									...
									<span class="text-success mr-1">User Reviews</span>
								</p>	
							</div>
						</div>
					</div>
					<div class="col-xl-3 col-sm-6 m-t35">
						<div class="card card-coin">
							<div class="card-body text-center">
								...
								<h2 class="text-black mb-2 font-w600">{{count($services)}}</h2>
								<p class="mb-0 fs-14">
									<svg width="29" height="22" viewBox="0 0 29 22" fill="none" xmlns="http://www.w3.org/2000/svg">
									...
									<span class="text-danger mr-1">Services</span>
								</p>	
							</div>
						</div>
					</div>
