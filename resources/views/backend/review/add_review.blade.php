...
<div class="content-body" style="min-height: 788px;">
        ...
        <form method="post" action="{{ route('store.clientreview') }}" enctype="multipart/form-data">
        	@csrf
            ...
            <div class="form-group">
                ...
                <textarea name="client_comment" class="form-control" rows="4" id="comment"></textarea>
