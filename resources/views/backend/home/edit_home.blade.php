...
<div class="content-body" style="min-height: 788px;">
        ...
        <form method="post" action="{{ route('update.home') }}" >
        	@csrf
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" name="home_description" id="summernote">
             ...
             <div class="form-group">
                ...
                <input type="text" name="total_users" class="form-control input-default "value="{{ $homecontent->total_users }}"  >
                @error('total_users')
                <span class="text-danger">{{ $message }}</span>
                @enderror
            ...
            <div class="form-group">
                ...
                <input type="text" name="total_project" class="form-control input-default " value="{{ $homecontent->total_project }}" >
                @error('total_project')
                <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
