					...
					<div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="{{route('add.information')}}" class="btn btn-info">Add Information <span class="btn-icon-right"><i class="fa fa-plus"></i></span>
                                </a>
                            </div>
                            <div class="card-body">
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" href="{{ route('edit.information',$item->id) }}">Edit</a>
                                                        <a class="dropdown-item" href="{{ route('delete.information',$item->id) }}">Delete</a>
                                                    </div>
                                                </div>
                                            </td>
                                            </tr>
