                                ...
                                <div class="basic-form">
                                    ...
                                    @csrf
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" rows="4" name="service_description" id="comment"></textarea>
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <div class="custom-file">
                                                <input type="file" name="service_icon" class="custom-file-input" id="image">
                                                <label class="custom-file-label">Choose file</label>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <img id="showImg" src="{{url('upload/no_image.jpg')}}" style="width: 100px; height: 100px;" alt="">
                                        </div>     
